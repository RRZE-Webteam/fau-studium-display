...
if (in_array('student_advice', $items) || in_array('subject_specific_advice', $items)) {
    ...
    if (in_array('student_advice', $items)) {
        ...
        $student_advice_link_text = $data[ 'student_advice' ][ 'link_text' ] ?? '';
    ...
    $student_advice .= '</div></section></div>';
}
